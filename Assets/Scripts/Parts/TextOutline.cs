...
public class TextOutline : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //    outline.transform.localRotation = new Quaternion(0, 0, 0, this.transform.localRotation.w);   
    ...
    void LateUpdate()
    {
        ...
        //    other.offsetZ = textMesh.offsetZ + 0.01f;            

        //    //bool doublePixel = resolutionDependant && (Screen.width > doubleResolution || Screen.height > doubleResolution);
        //    ////Vector3 pixelOffset = GetOffset(i) * (doublePixel ? 2.0f * pixelSize : pixelSize);
        //    //Vector3 pixelOffset = GetOffset(3) * (doublePixel ? 2.0f * pixelSize : pixelSize);
        ...
        //    other.transform.localPosition += GetOffset(3).normalized * 0.05f;
        //}
    }
